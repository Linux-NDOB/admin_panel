<template>
    <Layout>
        <div
            ...
            <form @submit.prevent="" class="space-y-6 mb-4">

                <h5 class="text-xl text-center font-medium text-gray-900 dark:text-white">Porfavor ingrese el NIT del Hotel
                </h5>

                <Input size="lg" placeholder="Porfavor ingrese el NIT del Hotel" label="NIT del hotel">
                <template #prefix>
            ...
            <form @submit.prevent="" class="space-y-6">
                ...
                <div class="grid gap-6">
                    ...
                    <Input :disabled="true" size="md" placeholder="No se puede editar" label="NIT">
                    <template #prefix>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <Input size="md" placeholder="" label="Nombre">
                    <template #prefix>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <Input size="md" placeholder="" label="Ciudad">
                    <template #prefix>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <Input size="md" placeholder="" label="Direccion">
                    <template #prefix>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <Input size="md" placeholder="" label="Habitaciones">
                    <template #prefix>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19.707
                                9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1
                                1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0
                                2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z" />

                        </svg>
                    </template>
                    </Input>

                    <Button color="default" class="w-sm">Actualizar Hotel</Button>
